...
<meta charset="utf-8">
<title>Añadir descripción</title>
...
<form method="post" action="_add_productdb.php" enctype="multipart/form-data" >
    <div class="column">
<h1>Añadir nueva producto</h1>
    ...
    <textarea id="summernote" name="descripcion" class="jqte-test" placeholder="Escribe tu reseña"></textarea>    </div>
            <br/>
    </div>
    <div class="miniatura">
 ...
 <select name="categoria" ><?php 
	...
	?>
    <option value="<?php echo $r['id_Categoria'];?>"><?php echo $r['nombre'];?></option>
   <?php } ?>
    </select>
    <br/>  
